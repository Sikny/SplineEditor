...
namespace SplineEditor.Runtime {
    public static class BezierUtils {
        ...
        private static List<BezierPos> GenerateFixedDistanceFrames(BezierNode startPoint, BezierNode endPoint,
            ...
            if (Mathf.Abs(result[result.Count - 1].BezierDistance - frames[framesCount - 1].BezierDistance) <
                3 * step / 4) {
        ...
        private static Vector3 ComputeTangent(BezierNode startPoint, BezierNode endPoint, float t) {
            Vector3 startPos = startPoint.transform.position,
                ...
                startEndTan = startPoint.GlobalTangentEnd,
                endStartTan = endPoint.GlobalTangentStart;
